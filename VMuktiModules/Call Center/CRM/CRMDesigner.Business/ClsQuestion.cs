...
namespace CRMDesigner.Business
{
    public class ClsQuestion : ClsBaseObject
    {
        ...
        public override bool MapData(DataRow row)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "MapData()", "ClsQuestion.cs");
                return false;
        ...
        public static void Delete(int ID)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "Delete()", "ClsQuestion.cs");
            }
        ...
        public int Save()
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "Save()", "ClsQuestion.cs");
                return 0;
            }
        }
