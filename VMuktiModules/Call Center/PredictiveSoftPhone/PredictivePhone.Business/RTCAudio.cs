...
namespace PredictivePhone.Business
{
    ...
    public class RTCAudio
    {
        ...
        private string strHangUpModule = string.Empty;

        public string HangUpModule
        {
            get { return strHangUpModule; }
            set { strHangUpModule = value; }
        }
        ...
        public delegate void delStatus(RTCAudio sender, string status, string Number,string strModuleName);
        ...
        void dt_Tick(object sender, EventArgs e)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "dt_Tick()", "RTCAudio.cs");
            }
        }
        ...
        public void SetIncomingPhoneNumber(string number)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "SetIncomingPhoneNumber()", "RTCAudio.cs");
            }
        }

        public void SetHangUpModuleName(string strModuleName)
        {
            try
            {
                this.strHangUpModule = strModuleName;
            }
            catch (Exception ex)
            {
                VMuktiHelper.ExceptionHandler(ex, "SetHangUpModuleName()", "RTCAudio.cs");
            }
        }
