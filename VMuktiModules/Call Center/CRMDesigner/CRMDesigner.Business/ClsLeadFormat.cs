...
namespace CRMDesigner.Business
{
    public class ClsLeadFormat : ClsBaseObject
    {
	    ...
	    private string _FormatName = CRMDesigner.Common.ClsConstants.NullString;
        ...
        public override bool MapData(DataRow row)
        {
            ...
            {
                ex.Data.Add("My Key", "VMukti--:--VmuktiModules--:--Call Center--:--CRMDesigner--:--CRMDesigner.Business--:--ClsLeadFormat.cs--:--MapData(DataRow row)--");
