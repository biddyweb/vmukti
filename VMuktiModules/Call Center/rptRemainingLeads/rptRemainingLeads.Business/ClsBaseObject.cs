...
namespace rptRemainingLeads.Business
{
    public abstract class ClsBaseObject
    {
        ...
        public virtual bool MapData(DataSet ds)
        {
            ...
            {
                ex.Data.Add("My Key", "VMukti--:--VmuktiModules--:--Call Center--:--rptRemainingLeads--:--rptRemainingLeads.Business--:--ClsBaseObject.cs--:--MapData()--");
                VMuktiAPI.ClsException.LogError(ex);
                VMuktiAPI.ClsException.WriteToErrorLogFile(ex);
                return false;
            }
        }
        ...
        public virtual bool MapData(DataTable dt)
        {
            ...
            {
                ex.Data.Add("My Key", "VMukti--:--VmuktiModules--:--Call Center--:--rptRemainingLeads--:--rptRemainingLeads.Business--:--ClsBaseCollection.cs--:--MapData()--");
                VMuktiAPI.ClsException.LogError(ex);
                VMuktiAPI.ClsException.WriteToErrorLogFile(ex);
                return false;
            }
