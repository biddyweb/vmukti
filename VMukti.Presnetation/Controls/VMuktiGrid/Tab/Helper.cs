...
namespace VMuktiGrid.ctlTab
{
    ...
    {  
        ...
        public static T FindParentControl<T>(DependencyObject outerDepObj) where T : DependencyObject
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "FindParentControl()", "Controls\\VMuktiGrid\\Tab\\Helper.cs");                
                return null;
            }
        }
        ...
        public static object CloneElement(object elementToClone)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "CloneElement()", "Controls\\VMuktiGrid\\Tab\\Helper.cs");                
                return null;
            }
        }
        ...
        public void Dispose()
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "Dispose()", "Controls\\VMuktiGrid\\Tab\\Helper.cs");
            }
        }
        ...
        public void Dispose(bool disposing)
        {
            if (!this.disposed)
			{
				if (disposing)
				{
					...
					{
                        VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "Dispose(bool disposing)", "Controls\\VMuktiGrid\\Tab\\Helper.cs");
					}
				}
				disposed = true;
			}
