...
namespace CRMDesigner.DataAccess
{
    ...
    public class ClsDataServiceBase
    {
        ...
        protected static string GetConnectionString()
        {
           ...
           // return @"Data Source=192.168.1.189;Initial Catalog=VMukti;User ID=sa;PassWord=mahavir";
        ...
        protected DataSet ExecuteDataSet(out SqlCommand cmd, string cmdText, CommandType cmdType, params IDataParameter[] procParams)
        {
            ...
            try
            {
                ...
                //    cnx = new SqlConnection("Data Source=192.168.1.13;Initial Catalog=VMukti;User ID=sa;PassWord=mahavir");
                    cmd.Connection = cnx;
                    cnx.Open();
                }
                else
            ...
            if (paramValue != DBNull.Value)
            {
                switch (paramType)
                {
                    ...
                    case SqlDbType.Bit:
                        ...
                        if ((int)paramValue < 0 || (int)paramValue > 1) paramValue = CRMDesigner.Common.ClsConstants.NullInt;
                        paramValue = CheckParamValue((int)paramValue);
                        break;
        ...
        {
            Guid returnVal = CRMDesigner.Common.ClsConstants.NullGuid;
            if (value is string)
            {
        ...
        {
            if (paramValue.Equals(CRMDesigner.Common.ClsConstants.NullGuid))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(CRMDesigner.Common.ClsConstants.NullDateTime))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(CRMDesigner.Common.ClsConstants.NullDouble))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(CRMDesigner.Common.ClsConstants.NullFloat))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(CRMDesigner.Common.ClsConstants.NullDecimal))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(CRMDesigner.Common.ClsConstants.NullInt))
            {
                return DBNull.Value;                
            }
            else
