<<<<<<< HEAD:VMuktiModules/Call Center/SIPUserInfo/SIPUserInfo.DataAccess/ClsDataServiceBase.cs
...
*/
=======
>>>>>>> b74131bacb80d82c79711cf70fe93af3fb611b40:VMuktiModules/Call Center/SIPUserInfo/SIPUserInfo.DataAccess/ClsDataServiceBase.cs
using System;
using System.Data;
...
namespace SIPUserInfo.DataAccess
{
    ...
    public class ClsDataServiceBase
    {
            ...
            if (paramValue != DBNull.Value)
            {
                switch (paramType)
                {
                    ...
                    case SqlDbType.Bit:
                        ...
                        if ((int)paramValue < 0 || (int)paramValue > 1) paramValue = SIPUserInfo.Common.ClsConstants.NullInt;
                        paramValue = CheckParamValue((int)paramValue);
                        break;
        ...
        {
            Guid returnVal = SIPUserInfo.Common.ClsConstants.NullGuid;
            if (value is string)
            {
        ...
        {
            if (paramValue.Equals(SIPUserInfo.Common.ClsConstants.NullGuid))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(SIPUserInfo.Common.ClsConstants.NullDateTime))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(SIPUserInfo.Common.ClsConstants.NullDouble))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(SIPUserInfo.Common.ClsConstants.NullFloat))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(SIPUserInfo.Common.ClsConstants.NullDecimal))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(SIPUserInfo.Common.ClsConstants.NullInt))
            {
                return DBNull.Value;                
            }
            else
