...
namespace Campaign.Business
{
    public class ClsTreatment : ClsBaseObject
    {
        ...
        private string _TreatmentName = Campaign.Common.ClsConstants.NullString;
        ...
        public override bool MapData(DataRow row)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "MapData()", "ClsTreatment.cs");
            }
        ...
        public void Save(IDbTransaction txn)
        {
            try
            {
                new Campaign.DataAccess.ClsCampaignDataService(txn).CampaignTreatments_Save(_CampID, _ID);
            }
            catch (Exception ex)
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "Save()", "ClsTreatment.cs");
            }
