...
namespace VMuktiAudio.VistaService
{
    ...
    public class RTCAudio
    {
        ...
        public void DisConnect()
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "DisConnect()", "VMuktiAudio.VistaService\\RTCAudio.cs");
            }
        }
        ...
        public void fncTransfer(string Number)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "fncTransfer()", "VMuktiAudio.VistaService\\RTCAudio.cs");
            }
        }
        ...
        public void fncSpk(string status)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "fncSpk()", "VMuktiAudio.VistaService\\RTCAudio.cs");
            }
        }
        ...
        public void fncMic(string status)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "fncMic()", "VMuktiAudio.VistaService\\RTCAudio.cs");
            }
        }
        ...
        public void fncMute(string status)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "fncMute()", "VMuktiAudio.VistaService\\RTCAudio.cs");
            }
        }
        ...
        public void fncHold(string status)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "fncHold()", "VMuktiAudio.VistaService\\RTCAudio.cs");
            }
        }
        ...
        public void fncSendDTMF(string number)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "fncSendDTMF()", "VMuktiAudio.VistaService\\RTCAudio.cs");
            }
        }
        ...
        public void fncAnser()
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "fncAnser()", "VMuktiAudio.VistaService\\RTCAudio.cs");
            }
        }
        #endregion
        ...
        private void OnInfoEvent(IRTCInfoEvent InfoEvent)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "OnInfoEvent()", "VMuktiAudio.VistaService\\RTCAudio.cs");
            }
        }
