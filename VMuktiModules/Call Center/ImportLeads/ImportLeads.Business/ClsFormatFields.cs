...
namespace ImportLeads.Business
{
    public class ClsFormatField : ClsBaseObject
    {
        ...
        private string _LeadFieldName = ImportLeads.Common.ClsConstants.NullString;
        private int _LeadFieldSize = ImportLeads.Common.ClsConstants.NullInt;
        private int _StartPosition = ImportLeads.Common.ClsConstants.NullInt;
        ...
        public int LeadFieldSize
        {
            get { return _LeadFieldSize; }
            set { _LeadFieldSize = value; }
        }
        ...
        public override bool MapData(DataRow row)
        {
            try
            {
                ...
                LeadFieldSize = GetInt(row, "LeadFieldSize");
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "MapData()", "ClsFormatField.cs");
                return false;
            }
        }
