...
namespace ToneDetect.SharpPcap.Packets
{
	...
	public struct IPPorts_Fields{
		...
		public readonly static int X11 = 6000;
		public readonly static int X11_BEGIN = 6000;
	...
	public interface IPPorts
		{
			//UPGRADE_NOTE: Members of interface 'IPPorts' were extracted into structure 'IPPorts_Fields'. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1045"'
			// dummy value for protocols that don't use ports
			/// <summary> Number of well-known (aka privileged) ports.
			/// </summary>
			/// <summary> IP port mask.
			/// </summary>
		}
}