...
namespace DashBoard.DataAccess
{
    ...
    public class ClsDataServiceBase
    {
        ...
        protected static string GetConnectionString()
        {
            ...
            //return "Data Source=192.168.191.181;Initial Catalog=VMukti_CallCenter;User ID=sa;PassWord=mahavir";                
        }
            ...
            if (paramValue != DBNull.Value)
            {
                switch (paramType)
                {
                    ...
                    case SqlDbType.Bit:
                        ...
                        if ((int)paramValue < 0 || (int)paramValue > 1) paramValue = DashBoard.Common.ClsConstants.NullInt;
                        paramValue = CheckParamValue((int)paramValue);
                        break;
        ...
        {
            Guid returnVal = DashBoard.Common.ClsConstants.NullGuid;
            if (value is string)
            {
        ...
        {
            if (paramValue.Equals(DashBoard.Common.ClsConstants.NullGuid))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(DashBoard.Common.ClsConstants.NullDateTime))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(DashBoard.Common.ClsConstants.NullDouble))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(DashBoard.Common.ClsConstants.NullFloat))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(DashBoard.Common.ClsConstants.NullDecimal))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(DashBoard.Common.ClsConstants.NullInt))
            {
                return DBNull.Value;
            }
            else
