    ...
    public class ClsCampaignCollection : ClsBaseCollection<ClsCampaign>
    {
        ...
        public static ClsCampaignCollection GetAll()
        {
            try
            {
                ...
                //Function for getting all campaign data from ClsCampaignDataService
                obj.MapObjects(new ClsCampaignDataService().Campaign_GetAll());
                return obj;
            }
            catch (Exception ex)
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "GetAll()", "ClsCampaignCollection.cs");
            }
