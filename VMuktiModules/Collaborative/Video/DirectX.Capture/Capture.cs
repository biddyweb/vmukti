...
namespace DirectX.Capture
{
    ...
    public class Capture : ISampleGrabberCB
    {
        ...
        /// </remarks>
        public System.Windows.Controls.Canvas PreviewWindow
        {
        ...
        public System.Drawing.Size FrameSize
        {
            get
            {
                ...
                System.Drawing.Size size = new System.Drawing.Size(bmiHeader.Width, bmiHeader.Height);
                return (size);
            }
            set
            {
        ...
        protected System.Windows.Controls.Canvas previewWindow = null;				// Property Backer: Owner control for preview
        ...
        //   protected IVMRWindowlessControl videoWindow;
        ...
        const int WS_CHILD = 1073741824;                                  //change 
        const int WS_CLIPSIBLINGS = 67108864;                             //change 
        ...
        public void onPreviewWindowResize(object sender, System.Windows.SizeChangedEventArgs e)
        {
            if (videoWindow != null)
            {
                System.Windows.Point pt = previewWindow.TranslatePoint(new System.Windows.Point(), System.Windows.Application.Current.MainWindow);
                previewWindow.Tag = pt;
                videoWindow.put_WindowStyle(WS_CHILD | WS_CLIPSIBLINGS);
                videoWindow.SetWindowPosition((int)((System.Windows.Point)previewWindow.Tag).X, (int)((System.Windows.Point)previewWindow.Tag).Y, (int)previewWindow.ActualWidth + 1, (int)previewWindow.ActualHeight);
            }
        }

        public double[] PreviewWidowTag()
        {
            System.Windows.Point pt = previewWindow.TranslatePoint(new System.Windows.Point(), System.Windows.Application.Current.MainWindow);
            previewWindow.Tag = pt;
            double[] winXY = new double[2];
            winXY[0] = ((System.Windows.Point)previewWindow.Tag).X;
            winXY[1] = ((System.Windows.Point)previewWindow.Tag).Y;
        ...
        public void hideVideo()
        {
            if (videoWindow != null)
            {
                int hr = videoWindow.put_Visible(DsHlp.OAFALSE);
            }
        }
        ...
        public void showVideo()
        {
            if (videoWindow != null)
            {
                int hr = videoWindow.put_Visible(DsHlp.OATRUE);
                onPreviewWindowResize(null, null);
            }
        }
