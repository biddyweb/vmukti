...
namespace ImportLeads.Business
{
    public class ClsFileFormat : ClsBaseObject
    {
        ...
        private string _LeadFormatName = ImportLeads.Common.ClsConstants.NullString;
        private string _FormatType = ImportLeads.Common.ClsConstants.NullString;
        ...
        public override bool MapData(DataRow row)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "MapData()", "ClsFileFormat.cs");
                return false;
            }
        }

        //public static ClsFileFormat GetByGroupID(int ID)
        //{
        //    ClsFileFormat obj = new ClsFileFormat();
