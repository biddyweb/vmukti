...
#else
using _videoConference.ZipUnzip .Encryption;
#endif


namespace VMukti.ZipUnzip.Zip.Compression.Streams 
{
	...
	/// as the <see cref="_videoConference.ZipUnzip .GZip.GZipInputStream">GZipInputStream</see>.
	///
