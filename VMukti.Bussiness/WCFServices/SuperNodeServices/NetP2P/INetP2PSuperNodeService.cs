...
{
    [ServiceContract(CallbackContract = typeof(INetP2PSuperNodeService))]
    public interface INetP2PSuperNodeService
    {
        ...
        //void svcSetSpecialMsg(string from, string to, string msg, List<clsModuleInfo> lstModInfo, string IPAddress);
        ...
        void svcPageBuddyRetSetSpecialMsg(clsBuddyRetPageInfo objBuddyRetPageInfo, string IPAddress);
        ...
        void svcAddDraggedBuddy(string from, string to, string msg, List<clsModuleInfo> lstModInfo, string IPAddress);
    ...
    public interface INetP2PSuperNodeChannel : IClientChannel, INetP2PSuperNodeService
    {
    }
