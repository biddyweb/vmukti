...
namespace Script.DataAccess
{
    public class ClsDataServiceBase
    {
            ...
            if (paramValue != DBNull.Value)
            {
                switch (paramType)
                {
                    ...
                    case SqlDbType.Bit:
                        ...
                        if ((int)paramValue < 0 || (int)paramValue > 1) paramValue = Script.Common.ClsConstants.NullInt;
                        paramValue = CheckParamValue((int)paramValue);
                        break;
        ...
        {
            Guid returnVal = Script.Common.ClsConstants.NullGuid;
            if (value is string)
            {
        ...
        {
            if (paramValue.Equals(Script.Common.ClsConstants.NullGuid))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(Script.Common.ClsConstants.NullDateTime))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(Script.Common.ClsConstants.NullDouble))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(Script.Common.ClsConstants.NullFloat))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(Script.Common.ClsConstants.NullDecimal))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(Script.Common.ClsConstants.NullInt))
            {
                return DBNull.Value;
            }
            else
