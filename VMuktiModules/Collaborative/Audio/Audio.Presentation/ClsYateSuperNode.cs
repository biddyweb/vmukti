    ...
    class ClsYateSuperNode
    {
        ...
        public ClsYateSuperNode()
        {
            try
            {
                ...
                BasicHttpServer bhsHttpBootStrap = new BasicHttpServer(ref objHttpService, "http://" + VMuktiInfo.CurrentPeer.SuperNodeIP + ":80/SNService");
                bhsHttpBootStrap.AddEndPoint<IService>("http://" + VMuktiInfo.CurrentPeer.SuperNodeIP + ":80/SNService");
                bhsHttpBootStrap.OpenServer();

            }
            catch (Exception ex)
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "ClsYateSuperNode()", "Audio\\ClsYateSuperNode.cs");
            }
        }
        ...
        string ClsYateSuperNode_EntsvcAddSIPUser()
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "ClsYateSuperNode_EntsvcAddSIPUser()", "Audio\\ClsYateSuperNode.cs");                
                return null;
            }
        }
        ...
        string ClsYateSuperNode_EntsvcGetConferenceNumber()
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "ClsYateSuperNode_EntsvcGetConferenceNumber()", "Audio\\ClsYateSuperNode.cs");
                return null;
            }
        }
        ...
        void ClsYateSuperNode_EntsvcRemoveSIPUser(string strSIPNumber)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "ClsYateSuperNode_EntsvcRemoveSIPUser()", "Audio\\ClsYateSuperNode.cs");
            }
        }
    }
}
