...
namespace ToneDetect.SharpPcap.Packets
{
	...
	public struct IPProtocols_Fields{
		...
		/// </summary>
		/// <summary> IP protocol mask.
		/// </summary>
		public const int MASK = 0xff;
	}
	public interface IPProtocols
		{
			//UPGRADE_NOTE: Members of interface 'IPProtocols' were extracted into structure 'IPProtocols_Fields'. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1045"'
