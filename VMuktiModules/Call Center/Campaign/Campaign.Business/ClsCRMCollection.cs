    ...
    public class ClsCRMCollection : ClsBaseCollection<ClsCRM>
    {
        ...
        public static ClsCRMCollection GetAll()
        {
            try
            {
                ...
                //Function for getting all CRM data from ClsCampaignDataService
                obj.MapObjects(new ClsCampaignDataService().CRM_GetAll());
                return obj;
            }
            catch (Exception ex)
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "GetAll()","ClsCRMCollection.cs");
                return null;
            }
        }
    }
