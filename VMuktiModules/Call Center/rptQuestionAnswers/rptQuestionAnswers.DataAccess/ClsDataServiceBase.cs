...
namespace rptQuestionAnswers.DataAccess
{
    ...
    public class ClsDataServiceBase
    {
        ...
        public ClsDataServiceBase(IDbTransaction txn)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "ClsDataServiceBase()", "ClsDataServiceBase.cs");
            }
        }
        ...
        protected DataSet ExecuteDataSet(out SqlCommand cmd, string cmdText, CommandType cmdType, params IDataParameter[] procParams)
        {
            ...
            try
            {
                ...
                if (_isOwner)
                {
                    ...
                    cmd.Connection = cnx;
                    string a = cnx.ConnectionTimeout.ToString();
                    cnx.Open();
                }
                else
                {
            ...
            if (paramValue != DBNull.Value)
            {
                switch (paramType)
                {
                    ...
                    case SqlDbType.Bit:
                        ...
                        if ((int)paramValue < 0 || (int)paramValue > 1) paramValue = rptQuestionAnswers.Common.ClsConstants.NullInt;
                        paramValue = CheckParamValue((int)paramValue);
                        break;
        ...
        {
            Guid returnVal = rptQuestionAnswers.Common.ClsConstants.NullGuid;
            if (value is string)
            {
        ...
        {
            if (paramValue.Equals(rptQuestionAnswers.Common.ClsConstants.NullGuid))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(rptQuestionAnswers.Common.ClsConstants.NullDateTime))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(rptQuestionAnswers.Common.ClsConstants.NullDouble))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(rptQuestionAnswers.Common.ClsConstants.NullFloat))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(rptQuestionAnswers.Common.ClsConstants.NullInt))
            {
                return DBNull.Value;                
            }
            else
