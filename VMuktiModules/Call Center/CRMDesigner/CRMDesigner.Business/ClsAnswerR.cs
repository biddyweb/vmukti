...
namespace CRMDesigner.Business
{
    public class ClsAnswerR : ClsBaseObject
    {
        ...
        public override bool MapData(DataRow row)
        {
            ...
            {
                ex.Data.Add("My Key", "VMukti--:--VmuktiModules--:--Call Center--:--CRMDesigner--:--CRMDesigner.Business--:--ClsAnswerR.cs--:--MapData(DataRow row)--");
        ...
        public void Save()
        {
            ...
            {
                ex.Data.Add("My Key", "VMukti--:--VmuktiModules--:--Call Center--:--CRMDesigner--:--CRMDesigner.Business--:--ClsAnswerR.cs--:--Save()--");
                //ClsException.LogError(ex);
                //ClsException.WriteToErrorLogFile(ex);
                System.Text.StringBuilder sb = new StringBuilder();
                sb.AppendLine(ex.Message);
