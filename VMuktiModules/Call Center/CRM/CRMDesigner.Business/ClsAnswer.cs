...
namespace CRMDesigner.Business
{
    public class ClsAnswer : ClsBaseObject
    {
        ...
        public override bool MapData(DataRow row)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "MapData()", "ClsAnswer.cs");
                return false;
        ...
        public static void Delete(int QuesID)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "Delete()", "ClsAnswer.cs");
            }
        }
        ...
        public void Save()
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "Save()", "ClsAnswer.cs");
            }
        }
