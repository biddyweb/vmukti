...
namespace Dialer_AutoProgressive.Business
{
    public class ClsLead : ClsBaseObject
    {
        ...
        private long _PhoneNo = Dialer_AutoProgressive.Common.ClsConstants.NullLong;
        private int _LeadFormatID = Dialer_AutoProgressive.Common.ClsConstants.NullInt;
        private DateTime _DeletedDate = Dialer_AutoProgressive.Common.ClsConstants.NullDateTime;
        private int _DeletedBy = Dialer_AutoProgressive.Common.ClsConstants.NullInt;
        ...
        private bool _DNCFlag = Dialer_AutoProgressive.Common.ClsConstants.NullBoolean;
        private int _DNCBy = Dialer_AutoProgressive.Common.ClsConstants.NullInt;
        private long _ListID = Dialer_AutoProgressive.Common.ClsConstants.NullLong;
        private long _LocationID = Dialer_AutoProgressive.Common.ClsConstants.NullLong;
        private int _RecycleCount = Dialer_AutoProgressive.Common.ClsConstants.NullInt;
        private string _Status = Dialer_AutoProgressive.Common.ClsConstants.NullString;
        ...
        public static void Delete(int ID)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "Delete(int ID)", "ClsLead.cs");
            }
        }
        ...
        public static void Delete(int ID, IDbTransaction txn)
        {
            try
            {
                new Dialer_AutoProgressive.DataAccess.ClsUserDataService(txn).User_Delete(ID);
            }
            catch (Exception ex)
            {
                VMuktiHelper.ExceptionHandler(ex, "Delete(int ID, IDbTransaction txn)", "ClsLead.cs");
            }
        }
        ...
        {
         //   new Dialer.DataAccess.ClsUserDataService(txn).User_Save(ref _ID, _DisplayName, _RoleID, _FName, _LName, _EMail, _PassWord, _IsActive, _ModifiedBy, _RatePerHour, _OverTimeRate, _DoubleRatePerHour, _DoubleOverTimeRate);
         //   new Dialer.DataAccess.ClsUserDataService(txn).User_Save(ref _ID, _PhoneNo, _LeadFormatID, _CreatedDate, _CreatedBy, _DeletedDate, _DeletedBy, _IsDeleted, _ModifiedDate, _ModifiedBy, _DNCFlag, _DNCBy, _ListID,_LocationID,_RecycleCount);
        }
