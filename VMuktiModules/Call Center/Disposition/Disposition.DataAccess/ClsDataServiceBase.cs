...
namespace Disposition.DataAccess
{
    ...
    public class ClsDataServiceBase
    {
        ...
        protected static string GetConnectionString()
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "GetConnectionString()", "ClsDataSErvcieBase.cs");
                return null;
            }
        }
        ...
        public static IDbTransaction BeginTransaction()
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "BeginTransaction()", "ClsDataSErvcieBase.cs");
                return null;
            }
        }
        ...
        protected DataSet ExecuteDataSet(string cmdText, CommandType cmdType, params IDataParameter[] procParams)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "ExecuteDataSet()", "ClsDataSErvcieBase.cs");
                return null;
            }
        }
