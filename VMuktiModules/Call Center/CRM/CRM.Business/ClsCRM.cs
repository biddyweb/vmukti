...
namespace CRM.Business
{
    public class ClsCRM : ClsBaseObject
    {
        ...
        private int _ID = CRM.Common.ClsConstants.NullInt;
        private string _CRMURL = CRM.Common.ClsConstants.NullString;
        private string _CRMName = CRM.Common.ClsConstants.NullString;
        //private int _ScriptTypeID = ClsConstants.NullInt;
        private bool _IsActive = false;
        private bool _IsDeleted = false;
        private DateTime _CreatedDate = CRM.Common.ClsConstants.NullDateTime;
        private int _CreatedBy = CRM.Common.ClsConstants.NullInt;
        private DateTime _ModifiedDate = CRM.Common.ClsConstants.NullDateTime;
        private int _ModifiedBy = CRM.Common.ClsConstants.NullInt;
        ...
        public override bool MapData(DataRow row)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "MapData()", "ClsCRM.cs");
                return false;
            }
        }
        ...
        public static ClsCRM GetByCtlScriptID(int ID)
        {
            try
            {
                ...
                DataSet ds = new CRM.DataAccess.ClsCRMDataService().CRM_GetByID(ID);
                if (!obj.MapData(ds)) obj = null;
                return obj;
            }
            catch (Exception ex)
            {
                VMuktiHelper.ExceptionHandler(ex, "GetByCtlScriptID()", "ClsCRM.cs");
                return null;
            }
        }
        ...
        public static void Delete(int ID)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "Delete()", "ClsCRM.cs");
            }
        }
        ...
        public static void Delete(int ID, IDbTransaction txn)
        {
            ...
            new CRM.DataAccess.ClsCRMDataService(txn).CRM_Delete(ID);
            }
            catch (Exception ex)
            {
                VMuktiHelper.ExceptionHandler(ex, "Delete()", "ClsCRM.cs");
        ...
        public void Delete(IDbTransaction txn)
        {
            ...
            {
                VMuktiHelper.ExceptionHandler(ex, "Delete(IDbTransaction txn)", "ClsCRM.cs");
            }
        }
