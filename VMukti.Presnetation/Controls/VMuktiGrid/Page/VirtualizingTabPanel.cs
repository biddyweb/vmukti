...
namespace VMuktiGrid.ctlPage
{
    ...
    /// </summary>
    public class VirtualizingTabPanel : VirtualizingPanel, IScrollInfo, IDisposable
    {       
        ...
        private Size MeasureHorizontal(Size availableSize)
        {
            ...
            if (!flag)
            {
                ...
                CanScrollRightOrDown = LastVisibleIndex < _actualChildCount - 1;
                CanScrollLeftOrUp = FirstVisibleIndex > 0;
            }
        ...
        private void EnsureChildRects(int items)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "EnsureChildRects()", "Controls\\VMuktiGrid\\Page\\VirtualizingTabPanel.cs");
            }
        }
        ...
        public void LineLeft()
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "LineLeft()", "Controls\\VMuktiGrid\\Page\\VirtualizingTabPanel.cs");
            }
        }
        public void LineRight()
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "LineRight()", "Controls\\VMuktiGrid\\Page\\VirtualizingTabPanel.cs");
            }
        }
        public void LineUp()
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "LineUp()", "Controls\\VMuktiGrid\\Page\\VirtualizingTabPanel.cs");
            }
        }
        ...
        public void SetHorizontalOffset(double offset)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "SetHorizontalOffSet()", "Controls\\VMuktiGrid\\Page\\VirtualizingTabPanel.cs");
            }
        }
        public void SetVerticalOffset(double offset)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "SeterticalOffSet()", "Controls\\VMuktiGrid\\Page\\VirtualizingTabPanel.cs");
            }
        }
        ...
        public void Dispose()
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "Dispose()", "Controls\\VMuktiGrid\\Page\\VirtualizingTabPanel.cs");
            }
        }
        public void Dispose(bool disposing)
        {
            if (!this.disposed)
			{
				if (disposing)
				{
					...
					{
                        VMuktiAPI.VMuktiHelper.ExceptionHandler(ex, "Dispose(bool disposing)", "Controls\\VMuktiGrid\\Page\\VirtualizingTabPanel.cs");
					}
				}
				disposed = true;
			}
