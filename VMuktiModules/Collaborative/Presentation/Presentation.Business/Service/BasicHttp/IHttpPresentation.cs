...
{
    [ServiceContract]
    public interface IHttpPresentation
    {
        ...
        clsMessageContract svcGetSlide(clsMessageContract mcrecipient);
        ...
        IAsyncResult BeginsvcGetSlide(clsMessageContract mcSRecipient, AsyncCallback callback, object asyncState);
        clsMessageContract EndsvcGetSlide(IAsyncResult result);

    }

    public interface IHttpPresentationChannel : IHttpPresentation, IClientChannel
    {
    }
}
