...
namespace ToneDetect.SharpPcap.Packets
{
	...
	public struct EthernetProtocols_Fields{
		...
		/// <summary> Ethernet protocol mask.
		/// </summary>
	...
	public interface EthernetProtocols
		{
			//UPGRADE_NOTE: Members of interface 'EthernetProtocols' were extracted into structure 'EthernetProtocols_Fields'. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1045"'
		}
}