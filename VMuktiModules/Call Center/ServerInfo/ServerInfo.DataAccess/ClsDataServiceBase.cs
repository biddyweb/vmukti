<<<<<<< HEAD:VMuktiModules/Call Center/ServerInfo/ServerInfo.DataAccess/ClsDataServiceBase.cs
...
*/
=======
>>>>>>> b74131bacb80d82c79711cf70fe93af3fb611b40:VMuktiModules/Call Center/ServerInfo/ServerInfo.DataAccess/ClsDataServiceBase.cs
using System;
using System.Data;
...
namespace ServerInfo.DataAccess
{
    ...
    public class ClsDataServiceBase
    {
                ...
                if (paramValue != DBNull.Value)
                {
                    switch (paramType)
                    {
                        ...
                        case SqlDbType.Bit:
                            ...
                            if ((int)paramValue < 0 || (int)paramValue > 1) paramValue = ServerInfo.Common.ClsConstants.NullInt;
                            paramValue = CheckParamValue((int)paramValue);
                            break;
        ...
        {
            Guid returnVal = ServerInfo.Common.ClsConstants.NullGuid;
            if (value is string)
            {
        ...
        {
            if (paramValue.Equals(ServerInfo.Common.ClsConstants.NullGuid))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(ServerInfo.Common.ClsConstants.NullDateTime))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(ServerInfo.Common.ClsConstants.NullDouble))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(ServerInfo.Common.ClsConstants.NullFloat))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(ServerInfo.Common.ClsConstants.NullDecimal))
            {
                return DBNull.Value;
            }
            else
        ...
        {
            if (paramValue.Equals(ServerInfo.Common.ClsConstants.NullInt))
            {
                return DBNull.Value;                
            }
            else
