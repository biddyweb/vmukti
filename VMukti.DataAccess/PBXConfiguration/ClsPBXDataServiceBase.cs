...
namespace VMukti.DataAccess
{
    ...
    /// </summary>	
    ////////////////////////////////////////////////////////////////////////////
    public class ClsPBXDataServiceBase 
    {
        ...
        public ClsPBXDataServiceBase() : this(null) { }


        public ClsPBXDataServiceBase(IDbTransaction txn)
        {
            if (txn == null)
            {
                _isOwner = true;
        ...
        {
            //string strDbCredantials = "";
            //try
            //{
            //    return (System.Configuration.ConfigurationSettings.AppSettings["ConnectionString"].ToString());


            //    //StreamReader strReader = new StreamReader(AppDomain.CurrentDomain.BaseDirectory + "DBInfo.txt");
            //    //strDbCredantials = strReader.ReadLine();
            //    //strReader.Close();
            //    //strReader.Dispose();
            //}
            //catch (Exception exp)
