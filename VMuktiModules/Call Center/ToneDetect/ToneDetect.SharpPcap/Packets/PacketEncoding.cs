...
namespace ToneDetect.SharpPcap.Packets
{
	...
	public class PacketEncoding
	{
		...
		// 0-length array?
		//UPGRADE_NOTE: Final was removed from the declaration of 'EMPTY_BYTE_ARRAY '. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1003"'
		...
		private System.String _rcsid = "$Id: PacketEncoding.java,v 1.4 2002/07/10 23:18:20 pcharles Exp $";
