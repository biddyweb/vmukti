...
namespace CRMContainer.DataAccess
{
    ...
    public class ClsDataServiceBase
    {
        ...
        public ClsDataServiceBase(IDbTransaction txn)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "ClsDataServiceBase()", "ClsDataServiceBase.cs");
            }
        }
        ...
        protected static string GetConnectionString()
        {
            try
            {
            //return @"Data Source=210.211.254.132\SQLExpress;Initial Catalog=vmukti;User Id=sa;Password=mahavir;";
            return VMuktiAPI.VMuktiInfo.MainConnectionString;
            }

            catch (Exception exp)
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "GetConnectionString()", "ClsDataServiceBase.cs");
                return null;
            }
        }
        public static IDbTransaction BeginTransaction()
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "BeginTransaction()", "ClsDataServiceBase.cs");
                return null;
            }
        }
        ////////////////////////////////////////////////////////////////////////
        ...
        protected DataSet ExecuteDataSet(string cmdText, CommandType cmdType, params IDataParameter[] procParams)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "ExecuteDataSet()", "ClsDataServiceBase.cs");
                return null;
            }
        }
        ...
        protected void ExecuteNonQuery(string procName, params IDataParameter[] procParams)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "ExecuteNonQuery()", "ClsDataServiceBase.cs");
            }
        }
        ...
        protected SqlParameter CreateParameter(string paramName, SqlDbType paramType, object paramValue)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CreateParameter(1)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        protected SqlParameter CreateParameter(string paramName, SqlDbType paramType, ParameterDirection direction)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CreateParameter(2)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        protected SqlParameter CreateParameter(string paramName, SqlDbType paramType, object paramValue, ParameterDirection direction)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CreateParameter(3)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        protected SqlParameter CreateParameter(string paramName, SqlDbType paramType, object paramValue, int size)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CreateParameter(4)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        protected SqlParameter CreateParameter(string paramName, SqlDbType paramType, object paramValue, int size, ParameterDirection direction)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CreateParameter(5)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        protected SqlParameter CreateParameter(string paramName, SqlDbType paramType, object paramValue, int size, byte precision)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CreateParameter(6)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        protected SqlParameter CreateParameter(string paramName, SqlDbType paramType, object paramValue, int size, byte precision, ParameterDirection direction)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CreateParameter(7)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        ////////////////////////////////////////////////////////////////////////
        ...
        protected object CheckParamValue(string paramValue)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CheckParamValue(string paramValue)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        protected object CheckParamValue(Guid paramValue)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CheckParamValue(Guid paramValue)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        protected object CheckParamValue(DateTime paramValue)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CheckParamValue(DateTime paramValue)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        protected object CheckParamValue(double paramValue)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CheckParamValue(double paramValue)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        protected object CheckParamValue(float paramValue)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CheckParamValue(float paramValue)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        protected object CheckParamValue(Decimal paramValue)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CheckParamValue(Decimal paramValue)", "ClsDataServiceBase.cs");
                return null;
            }
        }
        protected object CheckParamValue(int paramValue)
        {
            ...
            {
                VMuktiAPI.VMuktiHelper.ExceptionHandler(exp, "CheckParamValue(int paramValue)", "ClsDataServiceBase.cs");
                return null;
            }
        }
    } //class 
